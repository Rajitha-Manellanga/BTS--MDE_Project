		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Passenger_passenger_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Passenger_passenger_id_feature", "_UI_Passenger_type"),
				 btsPackage.Literals.PASSENGER__PASSENGER_ID,
				 true,
				 false,
				 false,
	...
	protected void addFisrt_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Passenger_fisrt_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Passenger_fisrt_name_feature", "_UI_Passenger_type"),
				 btsPackage.Literals.PASSENGER__FISRT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLast_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Passenger_last_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Passenger_last_name_feature", "_UI_Passenger_type"),
				 btsPackage.Literals.PASSENGER__LAST_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEmailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Passenger_email_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Passenger_email_feature", "_UI_Passenger_type"),
				 btsPackage.Literals.PASSENGER__EMAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPhonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Passenger_phone_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Passenger_phone_feature", "_UI_Passenger_type"),
				 btsPackage.Literals.PASSENGER__PHONE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(btsPackage.Literals.PASSENGER__BOOKING,
				 btsFactory.eINSTANCE.createBooking()));

		newChildDescriptors.add
			(createChildParameter
				(btsPackage.Literals.PASSENGER__BAGGAGE,
