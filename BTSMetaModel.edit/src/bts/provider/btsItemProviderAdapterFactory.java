 ...
 * @generated
 */
public class btsItemProviderAdapterFactory extends btsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	...
	public void dispose() {
		...
		if (ticketItemProvider != null) ticketItemProvider.dispose();
		if (bookingItemProvider != null) bookingItemProvider.dispose();
		if (paymentItemProvider != null) paymentItemProvider.dispose();
		if (baggageItemProvider != null) baggageItemProvider.dispose();
		if (passengerItemProvider != null) passengerItemProvider.dispose();
		if (kioskItemProvider != null) kioskItemProvider.dispose();
		if (online_paymentItemProvider != null) online_paymentItemProvider.dispose();
