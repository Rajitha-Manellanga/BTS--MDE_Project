 ...
 * @generated
 */
public enum booking_status implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final booking_status[] VALUES_ARRAY =
		new booking_status[] {
			BOOKED,
			RESERVED,
			CANCELLED,
	 ...
	 * @generated
	 */
	public static final List<booking_status> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static booking_status get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			booking_status result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static booking_status getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			booking_status result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static booking_status get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private booking_status(int value, String name, String literal) {
		this.value = value;
		this.name = name;
